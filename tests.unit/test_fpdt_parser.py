...
class TestDynamicStringEventRecord:
    ...
    def test_init_fields(self, mock_header, sample_bytes, valid_string_bytes, string_size):
    ...
    def test_str_contains_expected(self, mock_header, sample_bytes, valid_string_bytes, string_size):
        record = DynamicStringEventRecord(mock_header, sample_bytes, valid_string_bytes, string_size)
        s = str(record)
    ...
    def test_to_xml_structure(self, mock_header, sample_bytes, valid_string_bytes, string_size):
        record = DynamicStringEventRecord(mock_header, sample_bytes, valid_string_bytes, string_size)
        xml_elem = record.to_xml()
